            ...
            <div class="fade-in">
                ...
                <div class="grid">
                    <div class="team-card glass">
                        ...
                        <p>Специалист по мобильным устройствам с опытом работы более 5 лет</p>
                    </div>
                    ...
                    <div class="team-card glass">
                        ...
                        <div class="team-skills">
                            ...
                            <span class="skill-tag">Сети</span>
                        </div>
                        <p>Эксперт по настройке и оптимизации компьютерных систем</p>
                    </div>
                    ...
                    <div class="team-card glass">
                        ...
                        <h3>Дмитрий</h3>
                        <p>Специалист по безопасности</p>
                        <div class="team-skills">
                            <span class="skill-tag">Антивирусы</span>
                            <span class="skill-tag">Восстановление</span>
                            <span class="skill-tag">Диагностика</span>
                        </div>
                        <p>Профессионал в области информационной безопасности</p>
                    </div>
                </div>
            </div>
        `;
